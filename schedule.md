...
| **Mon, Sep 22** | Module 2: Scientific Writing & Peer Review | **Structuring Papers and Arguments** | - IMRaD deep dive: what goes in each section? <br> - Building a logical narrative flow <br> - Workshop: outlining a paper from your literature review <br> - *Assignment: Literature review outline due*  <br> |
| **Wed, Sep 24** | Module 2: Scientific Writing & Peer Review | **The Ethics and Process of Peer Review** | - Understanding different review models (single-blind, double-blind, transparent) <br> - Identifying and mitigating bias (conscious and unconscious) <br> - COPE guidelines for ethical reviewing - *Assignment: Draft review due Oct 6* |
